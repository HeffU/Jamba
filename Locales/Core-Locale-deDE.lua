...
L["BG_COLOUR"] = "Hintergrund Farbe"
L["FONT"] = "Schriftart"
L["FONT_SIZE"] = "Schriftart Größe"
L["BAR_TEXTURES"] = "Status Balken Textur"
L["WIDTH"] = "Breite"
L["HEIGHT"] = "Höhe"
...
--------------------------
-- Core Locale
L["STATUSTEXT"] = "Der Wahnsinns MultiBoxing Assistent Ebony's Edition"
...
L["TEXT2"] = ""
L["TEXT3"] = "Vielen Dank das diese Alpha Version Testet"
L["TEXT4"] = ""
L["TEXT5"] = "Bei fehlern meldet euch bei mir"
L["TEXT6"] = ""
L["TEXT7"] = "Vielen Dank das ihr helft Jamba-EE noch Großartiger zumachen!"
L["TEXT8"] = ""
L["TEXT9"] = ""
L["TEXT10"] = ""
...
L["BOOST_COMMUNICATIONS"] = "Erhöhe Jamba zu Jamba Kommunikationen"
L["BOOST_COMMUNICATIONS_HELP"] = "Erfordert Neustart, kann zu Verbindungs abbrüchen führen."
L["USE_GUILD_COMMS"] = "Verwende Gilden Kommunikationen"
L["USE_GUILD_COMMS_INFO"] = "Alle Team Mitglieder müssen in der selben Gilde sein." 
...
L["ADD_GROUPS_MEMBERS"] = "Füge ein Gruppen Mitglied hinzu"
...
L["BUTTON_ADDALL_HELP"] = "Fügt alle Gruppen/Schlachtzugs Mitglieder der Team Liste hinzu"
...
L["BUTTON_REMOVE_HELP"] = "Entferne das ausgewählte Mitglied aus der Team Liste"
L["BUTTON_MASTER_HELP"] = "Ernenne das ausgewähle Mitglied zum Meister seiner Gruppe"
...
--------------------------
-- Message Locale
L["DEFAULT_CHAT_WINDOW"] = "Standart Chatfenster"
L["WHISPER"] = "Flüstern"
L["PARTY"] = "Gruppe" 
...
L["DEFAULT_MESSAGE"] = "Standart Nachricht"
L["DEFAULT_WARNING"] = "Standart Warnung"
...
--------------------------
-- Item-Use Locale
L["JAMBA-ITEM-USE"] = "Jamba-Gegenstände"
L["ITEM"] = "Gegenstand"
...
L["TOOLTIP_NOLONGER_IN_BAGS"] = "Entfernt Gegenständ die sich nicht länger in deiner Tasche befinden aus der Gegenstands Anzeige."
...
L["CLONES_TO_TAKE_TAXI_AFTER"] = "Diener Flug verzögernung (Sek)"
--Mount Locale
L["MOUNT"] = "Reittier"
...
--------------------------
-- Currency Locale
L["JAMBA_CURRENCY"] = "Jamba Währungen"
L["SHOW_CURRENCY"] = "Zeige Wähungen an"
...
L["DISPLAY_HEADER"] = "Team Anzeige Optionen"
L["SHOW"] = "Anzeigen"
L["SHOW_TEAM_FRAME"] = "Zeige Team Anzeige"
L["SHOW_TEAM_FRAME_HELP"] = "Zeige Jamba Team Anzeige"
...
L["SHOW_PARTY_HELP"] = "Zeige nur aktuelle Gruppen Mitglieder an."
L["HEALTH_POWER_GROUP"] = "Gesundheit & Ressourcen ausserhalb der Gruppe"
L["HEALTH_POWER_GROUP_HELP"] = "Aktualisiert Gesundheit und Ressourcen üner die aktuelle Gruppe hinaus \nBenötigt Gilden Kommunikationen!"
...
L["CHARACTERS_PER_BAR"] = "Anzahl der Charaktere per Reihe"
...
L["CLASS_POWER"] = "Zeigt Team Klassenessourcen an\n\nCombopunkte\nSeelensplitter\nHeilige Kraft\nRunen"
L["DEAD"] = "Tot"
...
L["CLASS_BAR_HEADER"] = "Klassenressourcen Anzeige"

--------------------------
-- Follow Locale
L["FOLLOW_BROKEN_MSG"] = "Folgen Unterborchen!"
L["FOLLOW_MASTER"] = "Folge dem Meister"
L["FOLLOW_MASTER_HELP"] = "Folge dem aktuellen Meister"
L["FOLLOW_TARGET"] = "Folge Ziel: <TargetName>"
L["FOLLOW_TARGET_HELP"] = "Folge einem Spezifischem Ziel"
...
L["FOLLOW_STROBING_ME_HELP"] = "Beginnt eine Sequenze von Folgebefehlen (Einstellbaren) \nAktueller Charakter."
...
L["FOLLOW_SET_MASTER"] = "Bestimmt Folgeziel durch Namen"
L["FOLLOW_SET_MASTER_HELP"] = "Bestimmt Folgeziel durch Namen"
L["TRAIN"] = "Folge Kette"
...
L["WARN_STOP_FOLLOWING_HELP"] = "Benachrichtigt den Meister wenn ein Charakter aufhört ihm zufolgen."
L["ONLY_IF_OUTSIDE_RANGE"] = "Nur warnen wenn ausserhalb der Folgereichweite"
L["ONLY_IF_OUTSIDE_RANGE_HELP"] = "Warnt nur wenn sich der Charakter ausserhalb der Reichweite befindet die benöigt wird um erneut zufolgen."
...
L["ANY_MEMBER_IN_COMBAT"] = "Ein Team Mitglied im Kampf ist"
L["FOLLOW_STROBING"] = "Wiederholtes Folgen aktiv"
L["FOLLOW_STROBING_AJM_FOLLOW_COMMANDS."] = "Wiederholtes Folgen wird durch /Jamba-Follow Befehle kontrolliert."
L["USE_MASTER_STROBE_TARGET"] = "Meister ist IMMER ziel des wiederholten Folgens"
L["PAUSE_FOLLOW_STROBING"] = "Pausiere Wiederholtes Folgen wenn ...."
L["DRINKING_EATING"] = "Esse/drinke"
L["IN_A_VEHICLE"] = "In einem Fahrzeug"
L["GROUP_FOLLOW_STROBE"] = "Kategorie für Wiederholtes Folgen"
...
L["REMOVE_VENDER_LIST"] = "Entfernen von der Kauf Liste"
...
L["ERROR_BAGS_FULL"] =  "Ich habe nicht genug Platz in meiner Tasche um alles zukaufen."
L["ERROR_GOLD"] = "Ich hab nicht genug Gold um alles zukaufen." 
L["ERROR_CURR"] = "Ich habe nicht genug der benötigten Währung um alles zukaufen."
...
L["TRADE_REAGENTS_HELP"] = "Handel Alle Handwerksmaterialien mit dem aktuelleb Meister"
...
L["ERR_WILL_NOT_TRADE"] = "Das Ziel ist kein Team Mitglied, Handel nicht möglich."
...
-- Requests
L["REQUESTS"] = "Anfragen"
L["DENY_DUELS"] = "Duelleinladungen ablehnen"
...
L["RELEASE_PROMPTS"] = "Team Anzeige zum Geistfreilassen anzeigen"
L["RELEASE_PROMPTS_HELP"] = "Sobald ein Team Mitglied stirbt wird auf alles Charakteren eine Anzeige eingeblendet mir der alle Charaktere gleichzeitig den Geistfreilassen können. "
...
L["ROLE_CHECKS"] = "Gruppen Rollen akzptieren" 
...
L["FOCUS_NOT_MASTER"] = "Warnt wenn kein Focusziel existiert"
L["FOCUS_NOT_MASTER_HELP"] = "Warnt wenn im Kampf kein Focusziel existiert (Minion)"
...
L["I_REFUSED_A_DUEL_FROM_X"] = function( challenger )
	return string.format( "Ich habe eine Duellanfrage von %s abgelehnt.", challenger )
end
...
L["FORWARD_WHISPERS_MASTER_RELAY"] = "Leite Unterhalungen zu und von dem Master weiter"
L["FORWARD_WHISPERS_MASTER_RELAY_HELP"] = "Leitet gefüstertes zum Master weiter und \nleitet antworten zu dem flüsterer zurück."
...
L["ORIGINATOR_REPLY_QUEUE"] = "Zeigt den Flüsternen im geflüster an den Meister an"
L["ORIGINATOR_REPLY_QUEUE_HELP"] = "Zeigt den Weiterleiteden Flüsterer im geflüster an den Meister an." 
...
L["QUESTINFORMATIONONE"] = "Jamba-Quest behandelt alle Team Mitgieder als wären sie Master."
L["QUESTINFORMATIONTWO"] = "Quest Actionen eines Charakters werden von allen anderen ebenfalls durchgeführt."
L["QUESTINFORMATIONTHREE"] = "Egal wer aktuell Master ist."
L["QUEST_HEADER"] = "Quest Annahme und Abgabe mit Jamba"
...
L["AUTO_ACCEPT_QUESTS"] = "Nimmt jede geteile Quest Automatisch an"
L["AUTO_ACCEPT_QUESTS_HELP"] = "Nimmt jede geteilte Quest Automatisch an unabhänging von Wem. "
...
L["ACCEPT_ESCORT_QUEST"] = "Team akzeptiert jede Eskortquest vom Team."
L["ACCEPT_ESCORT_QUEST_HELP"] = "Automatische annahme von Eskortquests die jemand im Team startet."
...
L["ENABLE_QUEST_COMPLETION"] = "Aktiviere automatische Quest abgabe"
...
L["COMPLETE_QUEST_WITH_TEAM_HELP"] = "Alle geben ihre Quest gleichzeitig mir dem Master ab."
...
L["AUTOMATICALLY_ACCEPTED_ESCORT_QUEST"] = function( questName )
	return string.format( "Eine Eskortquest wurde angenommen: %s", questName )
end
...
L["QUEST_TRACKER_HEADER"] = "Quest Anzeige Einstallungen"
L["ENABLE_TRACKER"] = "Aktiviere Quest Anzeige"
L["ENABLE_TRACKER_HELP"] = "Aktivie die Jamba Quest Anzeige"
L["UNLOCK_TRACKER"] = "Entriegel Quest Anzeige"
L["UNLOCK_TRACKER_HELP"] = "Entriegel die Jamba Questanzeige. \n Halte[Alt] zum verschieben"
L["HIDE_BLIZZ_OBJ_TRACKER"] = "Verstecke Blizzards Quest Anzeige" 
L["HIDE_BLIZZ_OBJ_TRACKER_HELP"] = "Versteckt die Standart Blizzard Quest verfolgung."
L["SHOW_JOT_ON_MASTER"] = "Zeige Quest nur auf Master"
L["SHOW_JOT_ON_MASTER_HELP"] = "Zeigt die Jamba Quest Anzeige nur auf dem Master an."
L["HIDE_JOT_IN_COMBAT"] = "Verstecke Quests im Kamp"
L["HIDE_JOT_IN_COMBAT_HELP"] = "Verstecke die Jamba Quest Anzeige im Kampf"
...
L["GUILD_LIST"] = "Verstaue gelistete Gegenstände in der Gildenbank"
L["GUILD_LIST_HELP"] = "Verstaue gelistete Gegenstände Automatisch in der Gildenbak"
